...
namespace utf16 {
	...
	bool is_alpha(const char16_t* test_char) noexcept {
		if( *test_char == 0 ) return false;
		auto c32 = read_utf16(test_char);
	...
	bool is_ascii(const char16_t* test_char) noexcept {
		auto c32 = read_utf16(test_char);
		return ( c32 >= 0 && c32 < 128 );
	}
	
	bool is_digit(const char16_t* test_char) noexcept {
		if( *test_char == 0 ) return false;
		auto c32 = read_utf16(test_char);
		using namespace txt::database;
		uint8_t bits = static_cast<uint8_t>(read_entry_i(char_class_table, CHAR_CLASS_SIZE, c32));
	...
	bool is_lower_case(const char16_t* test_char) noexcept {
		if( *test_char == 0 ) return false;
		auto c32 = read_utf16(test_char);
		using namespace txt::database;
		uint8_t bits = static_cast<uint8_t>(read_entry_i(char_class_table, CHAR_CLASS_SIZE, c32));
	...
	bool is_numeric(const char16_t* test_char) noexcept {
		if( *test_char == 0 ) return false;
		auto c32 = read_utf16(test_char);
		using namespace txt::database;
		uint8_t bits = static_cast<uint8_t>(read_entry_i(char_class_table, CHAR_CLASS_SIZE, c32));
	...
	bool is_print(const char16_t* test_char) noexcept {
		if( *test_char == 0 ) return false;
		auto c32 = read_utf16(test_char);
		using namespace txt::database;
		uint8_t bits = static_cast<uint8_t>(read_entry_i(char_class_table, CHAR_CLASS_SIZE, c32));
	...
	bool is_space(const char16_t* test_char) noexcept {
		if( *test_char == 0 ) return false;
		auto c32 = read_utf16(test_char);
		using namespace txt::database;
		uint8_t bits = static_cast<uint8_t>(read_entry_i(char_class_table, CHAR_CLASS_SIZE, c32));
	...
	bool is_title_case(const char16_t* test_char) noexcept {
		if( *test_char == 0 ) return false;
		auto c32 = read_utf16(test_char);
		using namespace txt::database;
		uint8_t bits = static_cast<uint8_t>(read_entry_i(char_class_table, CHAR_CLASS_SIZE, c32));
	...
	bool is_upper_case(const char16_t* test_char) noexcept {
		if( *test_char == 0 ) return false;
		auto c32 = read_utf16(test_char);
		using namespace txt::database;
		uint8_t bits = static_cast<uint8_t>(read_entry_i(char_class_table, CHAR_CLASS_SIZE, c32));
